  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12 space-y-6">
        ...
        {choices.map(relicId => {
          ...
          return (
            <button
              ...
              className={`text-left rounded-2xl border-2 p-5 transition-all duration-150 focus:outline-none ${isSelected ? `bg-white/8 ${style.glow} shadow-lg scale-[1.02]` : "bg-white/3 border-white/8 hover:bg-white/6 hover:border-white/15"}`}
            >
      ...
      <div className="flex flex-col gap-3 max-w-sm mx-auto">
        <GameButton variant="primary" size="lg" className="w-full" onClick={handleTake} disabled={!selected || taking} loading={taking}>
